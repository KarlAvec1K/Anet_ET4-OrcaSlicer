...
Assert-Equal 'Anet ET4 Klipper 0.4 By Codex' $printer.name 'Portable printer preset name'
...
$processExpectations = @{
    'ET4 0.16 Quality By Codex' = @{ layer = '0.16'; outer = '30'; inner = '45'; infill = '55'; travel = '150'; accel = '600' }
    'ET4 0.20 Production By Codex' = @{ layer = '0.2'; outer = '35'; inner = '50'; infill = '60'; travel = '160'; accel = '700' }
    'ET4 0.28 Draft By Codex' = @{ layer = '0.28'; outer = '40'; inner = '60'; infill = '70'; travel = '180'; accel = '750' }
}
...
$filamentExpectations = @{
    'ET4 Generic PLA By Codex' = @{ nozzle = '210'; firstNozzle = '215'; bed = '55'; firstBed = '60'; mvs = '8'; type = 'PLA' }
    'ET4 Generic PLA+ By Codex' = @{ nozzle = '215'; firstNozzle = '220'; bed = '55'; firstBed = '60'; mvs = '7'; type = 'PLA' }
    'ET4 Silk PLA By Codex' = @{ nozzle = '210'; firstNozzle = '215'; bed = '55'; firstBed = '60'; mvs = '5.5'; type = 'PLA' }
    'ET4 Generic PETG By Codex' = @{ nozzle = '235'; firstNozzle = '240'; bed = '75'; firstBed = '80'; mvs = '6'; type = 'PETG' }
    'ET4 Generic TPU 95A By Codex' = @{ nozzle = '215'; firstNozzle = '220'; bed = '45'; firstBed = '50'; mvs = '2.5'; type = 'TPU' }
    'ET4 Generic ABS By Codex' = @{ nozzle = '240'; firstNozzle = '245'; bed = '95'; firstBed = '100'; mvs = '6'; type = 'ABS' }
    'ET4 Generic ASA By Codex' = @{ nozzle = '245'; firstNozzle = '250'; bed = '95'; firstBed = '100'; mvs = '5.5'; type = 'ASA' }
}
